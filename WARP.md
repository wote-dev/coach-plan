...
│   ├── planner/           # AI-powered lesson plan generation page
│   ├── coach-ai/          # Redirect page to planner
│   ├── layout.tsx         # Root layout with fonts & PageTransition
│   ├── page.tsx           # Homepage with HeroSection
│   └── globals.css        # Global styles & Tailwind config
├── components/
│   ├── Planner.tsx        # Form for AI lesson plan generation
...
1. **Client Component** (`Planner.tsx`) - Form with React state management
...
```
Planner Form → Server Action → Gemini API → Enhanced Plan → LessonPlanDisplay
```
...
- **/planner** - AI-powered lesson plan generator (main page)
- **/coach-ai** - Redirects to /planner
...
- Mapping defined in `/planner/page.tsx` (main page)
- `/coach-ai/page.tsx` redirects to `/planner`
...
Client-side validation in `Planner.tsx`:
