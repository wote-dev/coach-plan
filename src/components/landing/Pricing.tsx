  ...
  return (
    <section id="pricing" className="relative isolate py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <SectionHeader as="h2" size="lg" dotColor="white" className="mb-6">Pricing</SectionHeader>
        <p className="text-white/80 max-w-2xl">Simple, scalable pricing. Start free, upgrade as you grow.</p>
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
          {tiers.map((t) => (
            <SectionCard key={t.name} className={`p-6 sm:p-7 ${t.highlight ? 'ring-1 ring-white/30 bg-white/10' : ''}`}>
